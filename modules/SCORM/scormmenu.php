...
/** Navigator **/
$menus= array(_SCORMADMIN);
$links=array('index.php?mod=SCORM&file=scormmenu');
...
if (lnSecAuthAction(0, 'SCORM::', "export::", ACCESS_READ)) {
	$menu[] = '<a href=index.php?mod=SCORM&file=export>'.lnBlockImage($mod,'export').'<BR>'._SCORMEXPORT.'</a>';
} 
