...
function getScormCollection(){
	...
	$typedisplay = "&tpl=3";
	$communitytype = "&search_keys[core_8][]=changeme:277";//community scorm

	$link = $url.$totalresult.$objecttype.$communitytype.$typedisplay;
	...
	foreach ($domItem as $item)
	{
		...
		$no++;
		$html .= getScormInnerCollection($pid);
...
function getScormAllCollection(){
	$html="";
	$repositoryAddr = "http://203.185.132.234";
	$url = $repositoryAddr."/list/?cat=quick_filter";
	$totalresult='';
...
function getScormInnerCollection($pid){
	$html="";
	$repositoryAddr = "http://203.185.132.234";
	$url = $repositoryAddr."/list/?cat=quick_filter";
	$totalresult='';
	...
	$objecttype = "&search_keys[core_10][]=2";//collection
	$typedisplay = "&tpl=3";
	$communitytype = "&search_keys[core_8][]=".$pid;//community scorm
