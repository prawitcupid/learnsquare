...
//echo "repositoryAddr =".$_POST['RepositoryAddr']."<br>";
...
if($selectCollection!=''){
	...
	include_once 'getScormCollectionRepository.php';
  	$items = getScormAllCollection();
  	$collection = "";
	foreach($items as $item){
		$collection .= "&search_keys[core_8][]=".$item;
		//echo $item."<br>";
	}
	//$collection = "&search_keys[core_8][]=changeme:283&search_keys[core_8][]=changeme:279&search_keys[core_8][]=changeme:278&search_keys[core_8][]=changeme:281&search_keys[core_8][]=changeme:282&search_keys[core_8][]=changeme:280";//community scorm
}
if($selectResult!=''){
		...
		for($i=0; $i<$total ;$i++){
			...
			if($datatype!='xml'&&$check1===false&&$check2===false&&$check3===false){
				...
				if($datatype=='zip'){
					...
					//echo "<td align='center'><a href='#' onClick=\"upload('".$link_localtion."','".$data."','".$pid."','".$title."')\"><image src='images/import.gif' border='0'></a></td>";
					$url_repository = 'index.php?mod=SCORM&file=import_repository&link='.$link_localtion.'&title='.$title;
					echo "<td align='center'><a href='".$url_repository."'><image src='modules/Repository/images/download.png' border='0' title='"._DOWNLOADCONTENT."'></a></td>";
				}else{
					//echo "<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>";
					//echo "<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>";
				}
