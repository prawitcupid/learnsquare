...
SpawEngine.openDialog = function(module, dialog, editor, arguments, querystring, callback, tbi, sender,paths)
{
  ...
  var durl = SpawEngine.spaw_dir + 'dialogs/dialog.' + SpawEngine.platform + '?module=' + module + '&dialog=' + dialog 
    ...
    + '&scid=' + editor.scid + "&" + querystring + editor.getRequestUriConfigValue() + '&paths=' + paths;
