                ...
                + '.' + ed.toolbar_items[i].on_enabled_check + '(this.editor, ed.toolbar_items[i])'))
        {
          ...
          if (mitem.attachEvent)
          {
            ...
            mitem.attachEvent("onclick", 
              new Function("SpawEngine.active_context_menu.hide(); SpawEngine.active_context_menu = null;"
                + "SpawPG"+ed.toolbar_items[i].module + '.' + ed.toolbar_items[i].on_click + '(' + this.editor.name + '_obj, ' + ed.name + '_obj.toolbar_items[' + i + '], null,paths)'));
          ...
          else if (mitem.addEventListener)
          {
            ...
            mitem.addEventListener("click", 
              new Function("SpawEngine.active_context_menu.hide(); SpawEngine.active_context_menu = null;"
                + "SpawPG"+ed.toolbar_items[i].module + '.' + ed.toolbar_items[i].on_click + '(' + this.editor.name + '_obj, ' + ed.name + '_obj.toolbar_items[' + i + '], null,paths)'), false);
          }
          //alert(mitem.onclick);
