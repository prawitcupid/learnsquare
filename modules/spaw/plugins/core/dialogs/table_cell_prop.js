...
{
  SpawEngine.openDialog('core', 'colorpicker', spawEditor, SpawColor.parseRGB(curcolor), '', 'SpawTableCellPropDialog.showColorPickerCallback', null, this,paths);
}
...
{
  SpawEngine.openDialog('spawfm', 'spawfm', spawEditor, document.getElementById('cbackground').value, 'type=images', 'SpawTableCellPropDialog.showImgPickerCallback', null, null,paths);
}
