...
{
  SpawEngine.openDialog('core', 'colorpicker', spawEditor, SpawColor.parseRGB(curcolor), '', 'SpawTablePropDialog.showColorPickerCallback', null, this,paths);
}
...
{
  SpawEngine.openDialog('spawfm', 'spawfm', spawEditor, document.getElementById('tbackground').value, 'type=images', 'SpawTablePropDialog.showImgPickerCallback', null, null,paths);
}
