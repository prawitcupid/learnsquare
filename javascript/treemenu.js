...
//----------------------------------------------------------------------------------------------------
  ...
  this.iconClosed = "images/treeview/closed.gif";                   // icon closed (path)
  this.iconClosedHilight = "images/treeview/closed_hilight.gif";    // icon closed hilight (path)
  this.iconOpen = "images/treeview/open.gif";                       // icon open (path)
  this.iconOpenHilight = "images/treeview/open_hilight.gif";        // icon open hilight (path)
  this.iconPoint = "images/treeview/point.gif";                     // icon point (path)
  this.iconPointHilight = "images/treeview/point_hilight.gif";      // icon point hilight (path)

  this.imgBlank = "images/treeview/blank.gif";                      // blank image (path)
