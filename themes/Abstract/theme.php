...
?>
<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="ff9999">
<TR><TD VALIGN="TOP">

<!-- Start Outer Table-->
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="ff9999">
  <tr>
  ...
  <tr>
    ...
    <td><table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr height="25">
        	<?
			echo '<td background="themes/'.$thistheme.'/images/bg_main_menu.gif" align="left">';
			mainmenu();
			echo '</td>';
			?>
      </tr>
 ...
 <!--Start Content in the Middle-->    
    <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
		...
		<? 	if ($GLOBALS['expand']!=1) { 
            echo '<td background="themes/'.$thistheme.'/images/bg_left.gif" width="150" valign="top" align="center">';
			blocks(left);
			echo '</td>';
		 } 
		?>
...
echo "</td>";
    ...
    if ($GLOBALS['index'] == 1) { 
		echo '<td background="themes/'.$thistheme.'/images/bg_right.gif" width="150" valign="top" align="center">';
		blocks(right);
		echo "</td>\n";
	}
...
<TABLE WIDTH="800" BORDER="0" CELLSPACING="0" CELLPADDING="0">
	<TR HEIGHT="30">
	<TD WIDTH="800" BGCOLOR="#cc0066"  VALIGN="MIDDLE" ALIGN="CENTER">
				<? footmsg(); 
				echo "<a href='themes/";
				echo $thistheme;
...
function themesidebox($block) {
	...
	?>
		<table border="0" cellpadding="0" cellspacing="0"  width="150">
				<tr>
                    ...
                    echo '<td bgcolor="ff9999" width="150" height="30" align="center">';
	...
	?>
		<table border="0" align="center" width="150" height="30" cellpadding="0" cellspacing="0">
			<tr>
					<?
						echo '<td bgcolor="ff9999" width="150" height="20" align="center">';
