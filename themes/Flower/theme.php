...
?>
<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="f29fc5">
<TR><TD VALIGN="TOP">

<!-- Start Outer Table-->
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="f29fc5">
  <tr>
  ...
  <tr>
    ...
    <td><table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr height="25">
        	<?
			echo '<td background="themes/'.$thistheme.'/images/bg_main_menu.gif" align="center">';
			mainmenu();
			echo '</td>';
			?>
      </tr>
...
<TABLE WIDTH="800" BORDER="0" CELLSPACING="0" CELLPADDING="0">
	<TR HEIGHT="30">
	<TD WIDTH="800" BGCOLOR="#f29fc5"  VALIGN="MIDDLE" ALIGN="CENTER">
				<? footmsg(); 
				echo "<a href='themes/";
				echo $thistheme;
...
function themesidebox($block) {
	...
	?>
		...
		<table border="0" cellpadding="0" cellspacing="0"  width="150">
			<tr bgcolor="ec69a4"><td colspan="3" width="150">
            <?
			...
			?>
			<td bgcolor="ec69a4" width="140"><?=$content?></td>
            <?
